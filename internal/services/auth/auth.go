...
import (
	...
	"github.com/IskanderSh/sso/internal/lib/jwt"
	"github.com/IskanderSh/sso/internal/lib/logger/sl"
...
// Login checks if user with given credential ixists in the system
//
